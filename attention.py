...
class ConvNAT(ABC, Module, Generic[ConvType]):
    ...
    def __init__(self, conv_params: ConvParams,
        ...
        self.q_conv = self.conv_type(kernel_size=1, in_channels=intermediate_channels, out_channels=intermediate_channels)
        self.k_conv = self.conv_type(kernel_size=1, in_channels=intermediate_channels, out_channels=intermediate_channels)
        self.v_conv = self.conv_type(kernel_size=1, in_channels=intermediate_channels, out_channels=out_channels)
