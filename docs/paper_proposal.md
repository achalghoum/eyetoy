...
| Dataset     | Train Acc. | Top-1 Test Acc. | Top-5 Test Acc. | Epochs | Notes                            |
| :---------- | :--------- | :-------------- | :-------------- | :----- | :------------------------------- |
| CIFAR-10    | ~90%       | ~89%            | -               | 30     | Comparable to larger models    |
| CIFAR-100   | ~91%       | ~69%            | ~94%            | 50     | Strong Top-5                   |
| Caltech-256 | ~80%       | ~50%            | ~70%            | 50     | Suggests benefit from depth/global stack |
